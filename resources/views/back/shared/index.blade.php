...
<a class="btn btn-primary mb-3" href="{{ route('pages.create') }}" role="button">Créer une nouvelle page</a>

{{-- @elseif(Route::currentRouteName() === 'reservations.index')
<div class="text-top mb-3">
<a class="btn btn-primary mb-4" href="{{ route('pages.create') }}" role="button">Créer une nouvelle réservation</a>
</div> --}}
...
<a class="btn btn-primary mb-3" href="{{ route('posts.create') }}" role="button">Créer un nouveau post</a>

@elseif(Route::currentRouteName() === 'categories.index')
<a class="btn btn-primary mb-3" href="{{ route('categories.create') }}" role="button">Créer une nouvelle catégorie</a>


@elseif(Route::currentRouteName() === 'rooms.index')
<a class="btn btn-primary mb-3" href="{{ route('saverooms.create') }}" role="button">Créer une nouvelle chambre</a>
