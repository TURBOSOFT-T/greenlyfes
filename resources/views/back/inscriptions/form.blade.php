...
@section('main')
    ...
    <form
        ...
        action="{{ Route::currentRouteName() === 'inscriptions.edit' ? route('inscriptions.update', $inscription->id) : route('inscriptions.store') }}">

        @if(Route::currentRouteName() === 'inscriptions.edit')
            @method('PUT')
        @endif
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <x-back.card
                    ...
                    <x-back.input
                        name='title'
                        :value="isset($inscription) ? $inscription->nom: ''"
                        input='text'
                        :required="true">
                    </x-back.input>
                </x-back.card>
                ...
                <x-back.input
                name='prenom'
                :value="isset($inscription) ? $inscription->prenom : ''"
                input='text'
                :required="true">
                </x-back.input>
                </x-back.card>
                ...
                <x-back.input
                name='email'
                :value="isset($inscription) ? $inscription->email : ''"
                input='text'
                :required="true">
                </x-back.input>
                </x-back.card>
                ...
                <x-back.input
                name='telephone'
                :value="isset($inscription) ? $inscription->telephone : ''"
                input='text'
                :required="true">
                </x-back.input>
                ...
                <x-back.card
                    ...
                    <x-back.input
                        name='message'
                        :value="isset($inscription) ? $inscription->message : ''"
                        input='textarea'
                        rows=10
                        :required="true">
                    </x-back.input>
