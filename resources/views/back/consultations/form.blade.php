...
@section('main')
    ...
    <form
        ...
        action="{{ Route::currentRouteName() === 'consultations.edit' ? route('consultations.update', $consultation->id) : route('consultations.store') }}">

        @if(Route::currentRouteName() === 'consultations.edit')
            @method('PUT')
        @endif
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <x-back.card
                    ...
                    <x-back.input
                        name='title'
                        :value="isset($consultation) ? $consultation->nom: ''"
                        input='text'
                        :required="true">
                    </x-back.input>
                </x-back.card>
                ...
                <x-back.input
                name='prenom'
                :value="isset($consultation) ? $consultation->prenom : ''"
                input='text'
                :required="true">
                </x-back.input>
                </x-back.card>
                ...
                <x-back.input
                name='email'
                :value="isset($consultation) ? $consultation->email : ''"
                input='text'
                :required="true">
                </x-back.input>
                </x-back.card>
                ...
                <x-back.input
                name='telephone'
                :value="isset($consultation) ? $consultation->telephone : ''"
                input='text'
                :required="true">
                </x-back.input>
                ...
                <x-back.card
                    ...
                    <x-back.input
                        name='Message'
                        :value="isset($consultation) ? $consultation->message : ''"
                        input='textarea'
                        rows=10
                        :required="true">
                    </x-back.input>
