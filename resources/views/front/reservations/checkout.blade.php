                                    ...
                                    <div class="customer-details">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-grp">
                                                    <label for="">Nom :</label>
                                                    <input type="text" class="form-control" name="nom" value="{{ Auth::user()->name ?? ' ' }}" id="nom" required>
                                                    @error('nom')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-grp">
                                                    ...
                                                    <input type="text" class="form-control" name="prenom" value="{{ Auth::user()->last_name ?? ' ' }}" id="prenom" required>
                                            ...
                                            <div class="form-grp">
                                                ...
                                                <input type="text" class="form-control" name="email" value="{{ Auth::user()->email ?? ' ' }}" id="email" required>
                                            </div>
                                            <div class="form-grp">
                                            ...
                                            <div class="col-md-6">
                                                <div class="tp-checkout-input">
                                                    ...
                                                    <input name="nb_mois" type="number" id="nb_mois" placeholder="" required>
                                                </div>
                                            </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="tp-checkout-place">
                        ...
                        <div class="tp-order-info-list">
                            ...
                            <div class="mb-3">
                                <button type="button" class="btn btn-outline-primary type-btn" data-type="single">Une personne</button>
                                <button type="button" class="btn btn-outline-primary type-btn" data-type="double">Deuxième personne</button>
                            </div>
