                    ...
                    <div class="mt-5 mb-5">
                        <div class="card-body card-bodyx text-center ">
                            <h5 class="text-success">
                                ...
                                <b>
                                    Félicitation pour votre payement !
                                </b>
                            </h5>
                            <p>
                                Votre réservation a été enregistrée et payée  avec succès.
                            </p>
                            <br>
                            <div class="order-id">
                                <a   href="{{ route('home') }}" class="btn btn-success" style="background-color: #578b07;">
                                    Continuer
                                </a>
