                                ...
                                <div class="tp-shop-details__tab-content-box mb-20">
                                    <div class="tab-content" id="nav-tabContent">
                                       ...
                                       <div id="main-image" class="tp-shop-details__tab-big-img">
                                          <img 
                                              id="zoom-image" 
                                              src="{{ url('public/Image/' . $logement->image) }}" 
        ...
        lensSize: 200
            ...
            <div class="tp-product-area pb-120">
                <div class="container">
                    ...
                    <div class="row">
                        @if($logement->rooms->count() > 0)
                        @foreach($logement->rooms as $room)
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                            <div class="tp-product-item-2 mb-40">
                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="{{ route('details-room', ['id' => $room->id, 'slug' => Str::slug(Str::limit($room->name, 10))]) }}">
                                ...
                                <div class="tp-product-content-2">
                                    ...
                                    <div class="tp-product-button">
                                        <a class="tp-btn-price w-100 text-center" href="product-details.html">
                                            <i>
