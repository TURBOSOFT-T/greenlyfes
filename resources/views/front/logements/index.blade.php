               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index text-center">
                     <div class="breadcrumb__section-title-box">
                        <h3 class="breadcrumb__title">Bookings</h3>
                     </div>
                           ...
                           <div class="tp-product-widget-content">
                              <div class="tp-product-widget-category">
                                 <ul>
                                    ...
                                    <li><a  href="/logement/{{ $category->id }}"
                                        class="{{ isset($current_logement) && $current_logement->id === $logement->id ? 'selected' : '' }}">  {{ Str::limit($logement->title,25) }}<span>{{ $logement->books->count() }}</span></a></li>
                              @endforeach
                                 </ul>
                              </div>
                           </div>
