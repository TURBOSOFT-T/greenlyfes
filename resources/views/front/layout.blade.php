...
<main>
    ...
    <style>
        ...
        .carousel-item img {
            ...
            /* largeur du carousel */
            height: 500px;
            /* hauteur fixe souhaitée */
            object-fit: cover;
            /* ajuste l'image en la recadrant pour remplir */
        }
    ...
    <div class="tp-choose-3-area tp-choose-style-2 fix p-relative pt-150 pb-110">
        <div class="tp-choose-3-shape  d-sm-block">
            <img class="img-fluid" src="{{ url('public/Image/parametres/' . $config->imageabout) }}" height="300" width="400" alt="">
        </div>
        <div class="container">
                ...
                <div class="col-xl-7 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
                    <div class="tp-choose-3-thumb-box p-relative">
                        <div class="tp-choose-3-award" style="width: 100%; max-width: 800px; margin: auto;">
                            <img class="img-fluid" src="{{ url('public/Image/parametres/' . $config->imageabout) }}" alt="" width="1200" height="600">
                        </div>
                    ...
                    <div class="tp-service-item text-center">
                        <div class="tp-service-thumb-box p-relative">
                            <div class="tp-service-thumb">
                                <img src="{{ url('public/Image/' . $produit->image) }}" width="200 " height="200 " border-radius="8px" class="rounded shadow" alt="">
                            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="tp-video-2-right">
                            ...
                            <div class="text-center mt-30">
                                <a class="tp-btn-theme" href="https://greenlife-oliviera-village.com" class="tp-btn" target="_blank" rel="noopener noreferrer">Voir plus</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="tp-video-content text-center">
                            ...
                            <div class="tp-video-button">
                                <a class="tp-btn-border-white popup-video " style="font-size: 14px;" href="{{ Storage::url($gallery->video ?? '') }}{{-- {{ asset('storage/' . $gallery->video) }} --}}"><span>Voir
                                        la Vidéo</span></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tp-choose-title-box mb-20" style="text-align: justify">
                            ...
                            <p>
                                <strong style="text-transform: uppercase;">
                                  Fini  les impôts de votre pays d'origine grâce à notre carte de séjour d’un an,
...
Venez écrire le prochain chapitre de votre vie avec nous. 
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-project-2-item p-relative">
                                        ...
                                        <div class="tp-project-2-button">
                                            <a class="tp-btn-project" data-bs-toggle="modal" data-bs-target="#galleryModal" data-title="{{ $gallery->titre }}" data-description="{{ $gallery->description }}" data-image="{{ url('public/Image/' . $gallery->image) }}" href="#"><span>Voir plus</span>
                                                <i>
                                                    <svg width="15" height="10" viewBox="0 0 15 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M14.1543 4.99974L9.5111 9.644L8.7559 8.88987L12.1127 5.53307H0.0668316V4.4664H12.1127L8.7559 1.11067L9.5111 0.355469L14.1543 4.99974Z" fill="currentcolor" />
                                                    </svg>
    ...
    <div class="tp-contact-area tp-contact-2-style-2 tp-contact-style-3 theme-bg-2 p-relative">
        <div class="tp-contact-shape-1 ">
            <img src="{{ url('public/Image/parametres/' . $config->imagecontact) }}" width="500" height="405" alt="logo">
        </div>
                            ...
                            <div class="row gx-30">
                                ...
                                <div class="col-md-12 mb-20">
                                    <div class="tp-contact-input-box p-relative">
                                        ...
                                        <span class="tp-contact-icon">
                                            <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17.3327 1.99992C17.3327 1.08325 16.5827 0.333252 15.666 0.333252H2.33268C1.41602 0.333252 0.666016 1.08325 0.666016 1.99992V11.9999C0.666016 12.9166 1.41602 13.6666 2.33268 13.6666H15.666C16.5827 13.6666 17.3327 12.9166 17.3327 11.9999V1.99992ZM15.666 1.99992L8.99935 6.16658L2.33268 1.99992H15.666ZM15.666 11.9999H2.33268V3.66659L8.99935 7.83325L15.666 3.66659V11.9999Z" fill="currentcolor" />
                                            </svg>
                                        </span>
                                    </div>
                                    @error('email')
                                    ...
                                    <div class="tp-blog-item">
                                        <div class="tp-blog-thumb">
                                            <a href="{{ url('details-blog', ['id' => $post->id, 'slug' => Str::slug(Str::limit($post->title, 10))]) }}">
                                                ...
                                                <img class="w-100" width="200" height="300" src="{{ url('public/Image/posts/' . $post->image) }}">
                                            </a>
                                        </div>
                                        <div class="tp-blog-content p-relative">
                                            ...
                                            <h4 class="tp-blog-title mb-5">
                                                <a class="text-anim-3" href="{{ url('details-blog', ['id' => $post->id, 'slug' => Str::slug(Str::limit($post->title, 10))]) }}">{{ $post->title }}</a>
                                            </h4>
                                            <p class="mb-0 pb-20">{{ $post->meta_description }}</p>
                                            <a class="tp-blog-link" href="{{ url('details-blog', ['id' => $post->id, 'slug' => Str::slug(Str::limit($post->title, 10))]) }}">
