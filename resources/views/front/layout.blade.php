            ...
            <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    @foreach ($homes as $key => $home)
                        <div class="carousel-item   {{ $key == 0 ? 'active' : '' }}">
                            <img class="w-100"
                               src="{{ url('public/Image/' . $home->image) }}"
                                width="700" height="800" alt="Image">
                            ...
                            <div class="tp-service-3-item text-center mb-30 p-relative">
                                <div class="tp-service-3-icon pb-20">
                                    <span>
                                        ...
                                        <div class="tp-service-thumb">
                                            <img src="{{ url('public/Image/Services/' . $service->image) }}"
                                                width="200" height="200" border-radius="8" class="rounded shadow"
                                                alt="">
                                        </div>
                                    </span>
                                </div>
                                <div class="tp-service-3-content">
                                    <h4 class="tp-service-3-title mb-20"><a class="text-anim-3"
                                            href="#">{{ $service->title }}</a></h4>



                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#serviceModal" data-title="{{ $service->title }}"
                                        data-body="{{ $service->body }}"
                                        data-image="{{ url('public/Image/Services/' . $service->image) }}">
                                        Voir détails
                                    </button>
