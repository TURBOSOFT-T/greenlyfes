               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index text-center">
                     <div class="breadcrumb__section-title-box">
                        <h3 class="breadcrumb__title">Les écoles</h3>
                     </div>
               ...
               <div class="row">
                  <div class="col-xl-4 col-lg-4">
                     <div class="tp-product-sidebar">
                        ...
                        <div class="tp-product-widget mb-30">
                           ...
                           <div class="sidebar__widget-content">
                              <div class="sidebar__search">
                                 <form role="search" action="{{ url('rechercher') }}" method="get">
                                    @csrf
                        ...
                        <!-- categories -->
                        <div class="tp-product-widget mb-30">
                           <h3 class="sidebar__widget-title mb-0">Les filières </h3>
                           <div class="tp-product-widget-content">
                              <div class="tp-product-widget-category">
                                 <ul>
                                    @foreach ($filieres as $filiere)
                                    <li><a  href="/filiere/{{ $filiere->id }}"
                                        class="{{ isset($current_filiere) && $current_filiere->id === $filiere->id ? 'selected' : '' }}">  {{ Str::limit($filiere->title,25) }}<span>{{ $filiere->ecoles->count() }}</span></a></li>
                              @endforeach
                                 </ul>
                              </div>
                           </div>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                           <div class="tp-product-item-2 mb-40">
                              <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                 <a href="{{ route('details-ecole', ['id' => $ecole->id, 'slug' => Str::slug(Str::limit($ecole->title, 10))]) }}">
                                    <img src="{{ url('public/Image/' . $ecole->image) }}" width="200" height="150" alt="">
                                 </a>
                                 <!-- product action -->
                              ...
                              <div class="tp-product-content-2">
                                 ...
                                 <h3 class="tp-product-title-2">
                                    <a href="{{ route('details-ecole', ['id' => $ecole->id, 'slug' => Str::slug(Str::limit($ecole->title, 10))]) }}">{{ Str::limit($ecole->title, 15) }}</a>
                                 </h3>
                                 <div class="tp-product-price-wrapper-2 mb-15">
                                   {{--  <span class="tp-product-price-2 new-price">$166.00</span> --}}
                                 </div>
                                 <div class="tp-product-button">
                                    <a class="tp-btn-price w-100 text-center" href="{{ route('details-ecole', ['id' => $ecole->id, 'slug' => Str::slug(Str::limit($ecole->title, 10))]) }}">
                                       {{-- <i>
