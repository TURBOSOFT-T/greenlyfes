                  ...
                  <div class="tp-product-item-2 mb-40">
                     ...
                     <div class="tp-product-content-2">
                        ...
                        <h3 class="tp-product-title-2">
                           <a href="product-details.html">Garden Hose</a>
                        </h3>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                  <div class="tp-product-item-2 mb-40">
                     ...
                     <div class="tp-product-content-2">
                        ...
                        <h3 class="tp-product-title-2">
                           <a href="product-details.html">Watering Can</a>
                        </h3>
                        <div class="tp-product-price-wrapper-2 mb-15">
                           <span class="tp-product-price-2 new-price">$162.00</span>
                        </div>
                        <div class="tp-product-button">
                           <a class="tp-btn-price w-100 text-center" href="product-details.html">
                              <i>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                  <div class="tp-product-item-2 mb-40">
                     ...
                     <div class="tp-product-content-2">
                        ...
                        <h3 class="tp-product-title-2">
                           <a href="product-details.html">Hand Gloves</a>
                        </h3>
                        <div class="tp-product-price-wrapper-2 mb-15">
                           <span class="tp-product-price-2 new-price">$362.00</span>
                        </div>
                        <div class="tp-product-button">
                           <a class="tp-btn-price w-100 text-center" href="product-details.html">
                              <i>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                  <div class="tp-product-item-2 mb-40">
                     ...
                     <div class="tp-product-content-2">
                        ...
                        <h3 class="tp-product-title-2">
                           <a href="product-details.html">Garden Shoes</a>
                        </h3>
                        <div class="tp-product-price-wrapper-2 mb-15">
                           <span class="tp-product-price-2 new-price">$366.00</span>
                        </div>
                        <div class="tp-product-button">
                           <a class="tp-btn-price w-100 text-center" href="product-details.html">
                              <i>
